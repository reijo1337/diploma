...
\input{chapters/ru/Title}

%% abstract
\begin{abstract}
\input{chapters/ru/Abstract}
\end{abstract}

%% keywords
\begin{keyword}
\input{chapters/ru/Keywords}
\end{keyword}

\end{frontmatter}

%% main text
\input{chapters/ru/Introduction}

\input{chapters/ru/Edge}

\input{chapters/ru/Threholding}

\input{chapters/ru/Skeleton}

%\input{chapters/ru/Methodology}

\input{chapters/ru/Data}

\input{chapters/ru/Results}

\input{chapters/ru/Conclusion}

%\input{chapters/ru/Acknowledgement}
\section*{Список литературы}
\bibliographystyle{unsrt}
\bibliography{biblio}

\appendix
\input{chapters/ru/Appendix}
